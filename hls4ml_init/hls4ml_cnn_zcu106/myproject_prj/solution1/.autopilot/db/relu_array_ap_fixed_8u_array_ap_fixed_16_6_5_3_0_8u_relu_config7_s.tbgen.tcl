set moduleName relu_array_ap_fixed_8u_array_ap_fixed_16_6_5_3_0_8u_relu_config7_s
set isTopModule 0
...
set cdfgNum 19
set C_modelName {relu<array<ap_fixed,8u>,array<ap_fixed<16,6,5,3,0>,8u>,relu_config7>}
...
set portList { 
	...
	{ layer7_out_din sc_out sc_lv 128 signal 1 } 
...
set Spec2ImplPortList { 
	layer6_out { ap_fifo {  { layer6_out_dout fifo_data_in 0 312 }  { layer6_out_empty_n fifo_status 0 1 }  { layer6_out_read fifo_port_we 1 1 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer6_out_fifo_cap fifo_update 0 2 } } }
	layer7_out { ap_fifo {  { layer7_out_din fifo_data_in 1 128 }  { layer7_out_full_n fifo_status 0 1 }  { layer7_out_write fifo_port_we 1 1 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer7_out_fifo_cap fifo_update 0 2 } } }
}
