...
HD_PWD='C:/Users/OmilosNeonTexn/Desktop/fpga_cnn_hls4ml/hls4ml_init/hls4ml_init/hls4ml_init.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_cnn_min_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bd_cnn_min_wrapper.tcl -notrace
