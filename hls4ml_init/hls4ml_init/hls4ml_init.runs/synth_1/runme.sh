...
HD_PWD='C:/Users/OmilosNeonTexn/Desktop/fpga_cnn_hls4ml/hls4ml_init/hls4ml_init/hls4ml_init.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_cnn_min_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_cnn_min_wrapper.tcl
