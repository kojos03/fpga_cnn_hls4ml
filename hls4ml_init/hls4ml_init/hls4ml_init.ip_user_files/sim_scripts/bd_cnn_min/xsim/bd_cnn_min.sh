...
#
# Script generated by Vivado on Tue Mar 24 21:49:18 +0200 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bd_cnn_min.sh
...
#
# Usage        : bd_cnn_min.sh
#                bd_cnn_min.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bd_cnn_min.sh [-reset_run]
#                bd_cnn_min.sh [-reset_log]
#                bd_cnn_min.sh [-help]
#
...
# script info
echo -e "bd_cnn_min.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bd_cnn_min.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L zynq_ultra_ps_e_vip_v1_0_19 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L xlconstant_v1_1_9 -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L xbip_pipe_v3_0_10 -L xbip_dsp48_wrapper_v3_0_6 -L mult_gen_v12_0_22 -L floating_point_v7_1_19 -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_15 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bd_cnn_min xil_defaultlib.bd_cnn_min xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bd_cnn_min -key {Behavioral:sim_1:Functional:bd_cnn_min} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_cnn_min.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bd_cnn_min.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bd_cnn_min.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bd_cnn_min.sh [-help]\n\
Usage: bd_cnn_min.sh [-step]\n\
Usage: bd_cnn_min.sh [-lib_map_path]\n\
Usage: bd_cnn_min.sh [-reset_run]\n\
Usage: bd_cnn_min.sh [-reset_log]\n\
Usage: bd_cnn_min.sh [-keep_index]\n\
Usage: bd_cnn_min.sh [-noclean_files]\n\n\
