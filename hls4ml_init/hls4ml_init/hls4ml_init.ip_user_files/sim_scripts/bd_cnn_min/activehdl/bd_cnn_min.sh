...
#                script (type 'bd_cnn_min.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/OmilosNeonTexn/Desktop/fpga_cnn_hls4ml/hls4ml_init/hls4ml_init/hls4ml_init.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
