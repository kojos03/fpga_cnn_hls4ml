...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ bd_smoke_add_axi_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "bd_smoke_add_axi_0_0,add_axi,{}" *) (* core_generation_info = "bd_smoke_add_axi_0_0,add_axi,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=add_axi,x_ipVersion=1.0,x_ipCoreRevision=2114507048,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_S_AXI_CTRL_ADDR_WIDTH=6,C_S_AXI_CTRL_DATA_WIDTH=32}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* ip_definition_source = "HLS" *) (* x_core_info = "add_axi,Vivado 2024.2" *) 
...
/* synthesis syn_force_seq_prim="ap_clk" */;
  ...
  (* x_interface_info = "xilinx.com:signal:clock:1.0 ap_clk CLK" *) (* x_interface_mode = "slave ap_clk" *) (* x_interface_parameter = "XIL_INTERFACENAME ap_clk, ASSOCIATED_BUSIF s_axi_CTRL, ASSOCIATED_RESET ap_rst_n, FREQ_HZ 177776001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN bd_smoke_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0" *) input ap_clk /* synthesis syn_isclock = 1 */;
