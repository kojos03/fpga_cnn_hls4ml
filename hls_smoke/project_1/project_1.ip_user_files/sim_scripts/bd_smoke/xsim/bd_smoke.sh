...
#
# Script generated by Vivado on Wed Mar 18 20:59:08 +0200 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bd_smoke.sh
...
#
# Usage        : bd_smoke.sh
#                bd_smoke.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bd_smoke.sh [-reset_run]
#                bd_smoke.sh [-reset_log]
#                bd_smoke.sh [-help]
#
...
# script info
echo -e "bd_smoke.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bd_smoke.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L zynq_ultra_ps_e_vip_v1_0_19 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L generic_baseblocks_v2_1_2 -L fifo_generator_v13_2_11 -L axi_data_fifo_v2_1_32 -L axi_register_slice_v2_1_33 -L axi_protocol_converter_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bd_smoke xil_defaultlib.bd_smoke xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bd_smoke -key {Behavioral:sim_1:Functional:bd_smoke} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_smoke.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bd_smoke.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bd_smoke.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bd_smoke.sh [-help]\n\
Usage: bd_smoke.sh [-step]\n\
Usage: bd_smoke.sh [-lib_map_path]\n\
Usage: bd_smoke.sh [-reset_run]\n\
Usage: bd_smoke.sh [-reset_log]\n\
Usage: bd_smoke.sh [-keep_index]\n\
Usage: bd_smoke.sh [-noclean_files]\n\n\
