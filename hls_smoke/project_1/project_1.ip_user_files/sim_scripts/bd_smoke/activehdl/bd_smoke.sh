...
#                script (type 'bd_smoke.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/OmilosNeonTexn/Desktop/fpga_cnn_hls4ml/hls_smoke/project_1/project_1.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
