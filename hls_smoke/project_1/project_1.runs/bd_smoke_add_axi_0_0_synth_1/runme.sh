...
HD_PWD='C:/Users/OmilosNeonTexn/Desktop/fpga_cnn_hls4ml/hls_smoke/project_1/project_1.runs/bd_smoke_add_axi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_smoke_add_axi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_smoke_add_axi_0_0.tcl
