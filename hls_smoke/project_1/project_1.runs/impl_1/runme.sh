...
HD_PWD='C:/Users/OmilosNeonTexn/Desktop/fpga_cnn_hls4ml/hls_smoke/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_smoke_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bd_smoke_wrapper.tcl -notrace
