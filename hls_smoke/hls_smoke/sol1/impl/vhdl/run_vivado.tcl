...
set ip_vlnv xilinx.com:hls:add_axi:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project hls_smoke
...
dict set report_options topmodule "add_axi"
dict set report_options funcmodules {}
dict set report_options bindmodules add_axi_CTRL_s_axi
