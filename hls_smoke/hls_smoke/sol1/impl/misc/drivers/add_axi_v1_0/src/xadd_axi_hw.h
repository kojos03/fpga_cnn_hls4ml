...
#define XADD_AXI_CTRL_BITS_A_DATA  16
#define XADD_AXI_CTRL_ADDR_B_DATA  0x18
#define XADD_AXI_CTRL_BITS_B_DATA  16
#define XADD_AXI_CTRL_ADDR_C_DATA  0x20
#define XADD_AXI_CTRL_BITS_C_DATA  16
#define XADD_AXI_CTRL_ADDR_C_CTRL  0x24
